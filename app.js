const app = new Vue({
    ...
    data:{
        entradas: [
            {barCode:'0',nombre: 'Huevos / Blanquillos', precio:2.5, cantidad:1, total:'', fecha:'', stock:0, utilidad:0.5, ganancia:'', p: 0.1, Tp: ''},
            {barCode:'011',nombre:'Doritos flaming hot verdes', precio:18, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'022',nombre: 'Papas', precio:12, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'033',nombre: 'Papel higienico REGIO', precio:28, cantidad:1, total:'', fecha:'', stock:0, utilidad:5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501125144851',nombre: 'Electrolit Uva', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501125104688',nombre: 'Electrolit Naranja Mandarina', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501125149221',nombre: 'Electrolit Fresa Kiwi', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501125118562',nombre: 'Electrolit Lima Limon', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501125104411',nombre: 'Electrolit Coco', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501125174797',nombre: 'Electrolit Mora Azul', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501125104268',nombre: 'Electrolit Fresa', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'650240032301',nombre: 'Suerox naranja - mandarina', precio:20, cantidad:1, total:'', fecha:'', stock:0, utilidad:4, ganancia:'', p: 1, Tp: ''},
            {barCode:'650240035395',nombre: 'Suerox coco', precio:20, cantidad:1, total:'', fecha:'', stock:0, utilidad:4, ganancia:'', p: 1, Tp: ''},
            {barCode:'650240032271',nombre: 'Suerox uva', precio:20, cantidad:1, total:'', fecha:'', stock:0, utilidad:4, ganancia:'', p: 1, Tp: ''},
            {barCode:'650240032295',nombre: 'Suerox mora azul - hierbabuena', precio:20, cantidad:1, total:'', fecha:'', stock:0, utilidad:4, ganancia:'', p: 1, Tp: ''},
            {barCode:'613008738822',nombre: 'Arizona kiwi - fresa', precio:20, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'613008738846',nombre: 'Arizona sandía', precio:20, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'613008738808',nombre: 'Arizona mango', precio:20, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'613008765255',nombre: 'Arizona té verde', precio:17, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'613008765224',nombre: 'Arizona mango', precio:17, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'613008765286',nombre: 'Arizona kiwi con fresa', precio:17, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'613008765194',nombre: 'Arizona sandía', precio:17, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501000911783',nombre: 'Nescafé clásico 14g', precio:10, cantidad:1, total:'', fecha:'', stock:0, utilidad:2, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501058629142',nombre: 'Nescafé cappuccino vainilla 22g', precio:11, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501058629128',nombre: 'Nescafé cappuccino original 20g', precio:11, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501058629166',nombre: 'Nescafé cappuccino moka 22g', precio:11, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501000911790',nombre: 'Nescafé decaf 14g', precio:13, cantidad:1, total:'', fecha:'', stock:0, utilidad:3.25, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501073411173',nombre: 'Nestlé chocolate abuelita', precio:12, cantidad:1, total:'', fecha:'', stock:0, utilidad:1.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501020565935',nombre: 'LALA entera', precio:24, cantidad:1, total:'', fecha:'', stock:0, utilidad:3.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501020565959',nombre: 'LALA semidescremada', precio:24, cantidad:1, total:'', fecha:'', stock:0, utilidad:3.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501020565911',nombre: 'LALA deslactosada', precio:24, cantidad:1, total:'', fecha:'', stock:0, utilidad:3.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501020544398',nombre: 'NUTRI deslactosada', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:2.75, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501020540666',nombre: 'NUTRI clásica', precio:20, cantidad:1, total:'', fecha:'', stock:0, utilidad:2.60, ganancia:'', p: 1, Tp: ''},
            {barCode:'7503015181021',nombre: 'Leche DELITE 1lt', precio:15.5, cantidad:1, total:'', fecha:'', stock:0, utilidad:2.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7502261256712',nombre: 'Lacti BU 1lt', precio:17, cantidad:1, total:'', fecha:'', stock:0, utilidad:2, ganancia:'', p: 1, Tp: ''},
            {barCode:'7506205815867',nombre: 'Choco milk chocolate 18g', precio:7, cantidad:1, total:'', fecha:'', stock:0, utilidad:2.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7506205807589',nombre: 'Choco milk chocolate 160g', precio:29, cantidad:1, total:'', fecha:'', stock:0, utilidad:4, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501200483127',nombre: 'Harina PRONTO 350g', precio:33, cantidad:1, total:'', fecha:'', stock:0, utilidad:4, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501058631961',nombre: 'La lechera bolsa 209g', precio:18, cantidad:1, total:'', fecha:'', stock:0, utilidad:3.2, ganancia:'', p: 1, Tp: ''},
            {barCode:'7506475104722',nombre: 'La lechera lata 375g', precio:26, cantidad:1, total:'', fecha:'', stock:0, utilidad:2.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501003336125',nombre: 'Mermelada de fresa 270g', precio:28, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501058611062',nombre: 'Leche evaporada Carnation 360g', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7503015181076',nombre: 'Media crema DELITE', precio:12, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501158414310',nombre: 'Media crema SAN MARCOS', precio:16, cantidad:1, total:'', fecha:'', stock:0, utilidad:2.2, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501158415157',nombre: 'Media crema NUTRE', precio:10, cantidad:1, total:'', fecha:'', stock:0, utilidad:2.58, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501000912803',nombre: 'Nescafé clásico frasco 42g', precio:31, cantidad:1, total:'', fecha:'', stock:0, utilidad:3.8, ganancia:'', p: 1, Tp: ''},
            {barCode:'7500478005512',nombre: 'Crackets 135g', precio:15, cantidad:1, total:'', fecha:'', stock:0, utilidad:3.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501000658923',nombre: 'Marias gamesa 170g', precio:14, cantidad:1, total:'', fecha:'', stock:0, utilidad:1.5, ganancia:'', p: 1, Tp: ''},
            {barCode:'038629002716',nombre: 'Marianitas VAINILLA 185g', precio:12, cantidad:1, total:'', fecha:'', stock:0, utilidad:1.4, ganancia:'', p: 1, Tp: ''},
            {barCode:'038629001702',nombre: 'Marianitas NUEZ 185g', precio:12, cantidad:1, total:'', fecha:'', stock:0, utilidad:1.4, ganancia:'', p: 1, Tp: ''},
            {barCode:'038629002068',nombre: 'Marianitas COCO 185g', precio:12, cantidad:1, total:'', fecha:'', stock:0, utilidad:1.4, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501008726402',nombre: 'Matraquilla VAINILLA', precio:11, cantidad:1, total:'', fecha:'', stock:0, utilidad:2.2, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501008725405',nombre: 'Matraquilla NUEZ', precio:11, cantidad:1, total:'', fecha:'', stock:0, utilidad:2, ganancia:'', p: 1, Tp: ''},
            {barCode:'7500478003006',nombre: 'Gamesa DORADAS 224g', precio:28, cantidad:1, total:'', fecha:'', stock:0, utilidad:3.3, ganancia:'', p: 1, Tp: ''},
            {barCode:'7501008765012',nombre: 'Chavalin 100g', precio:14.5, cantidad:1, total:'', fecha:'', stock:0, utilidad:2, ganancia:'', p: 1, Tp: ''},
            ...
            {barCode:'',nombre: '', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'',nombre: '', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'',nombre: '', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'',nombre: '', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
            {barCode:'',nombre: '', precio:21, cantidad:1, total:'', fecha:'', stock:0, utilidad:3, ganancia:'', p: 1, Tp: ''},
